...
export class Client {
	...
	private readonly applicationHash: string = "e983dd1a";
	...
	public login: Record<AuthProviderId, AuthProvider["login"]> = {
		...
		googleDev: (redirectURI?: string): void => {
			this.startLogin(AuthProviderId.googleDev, redirectURI);
		},
	};
	public authProviders: Array<AuthProvider> = [
		...
		{
			id: AuthProviderId.googleDev,
			login: this.login[AuthProviderId.googleDev],
		},
	];

...
export interface HooksConfig {
	...
	queries?: {
		AdminPortal?: {
			mockResolve?: (ctx: Context<User, InternalClient>) => Promise<AdminPortalResponse>;
			preResolve?: (ctx: Context<User, InternalClient>) => Promise<void>;
			postResolve?: (ctx: Context<User, InternalClient>, response: AdminPortalResponse) => Promise<void>;
			customResolve?: (ctx: Context<User, InternalClient>) => Promise<void | AdminPortalResponse>;
			mutatingPostResolve?: (
				ctx: Context<User, InternalClient>,
				response: AdminPortalResponse

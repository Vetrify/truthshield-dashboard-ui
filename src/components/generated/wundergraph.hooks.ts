...
export type WUNDERGRAPH_OPERATION = "AdminPortal";
...
export interface HooksConfig {
	...
	queries?: {
		AdminPortal?: {
			mockResolve?: (hook: HookRequest) => Promise<AdminPortalResponse>;
			preResolve?: (hook: HookRequest) => Promise<void>;

			postResolve?: (hook: HookRequest & HookRequestWithResponse<AdminPortalResponse>) => Promise<void>;
			customResolve?: (hook: HookRequest) => Promise<void | AdminPortalResponse>;
			mutatingPostResolve?: (
				hook: HookRequest & HookRequestWithResponse<AdminPortalResponse>

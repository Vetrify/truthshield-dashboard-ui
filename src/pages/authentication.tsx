  ...
  return (
    <div className={styles.examplesContainer}>
      ...
      <p>
        ...
        call{' '}
        <a href='https://wundergraph.com/docs/overview/features/authentication_aware_data_fetching?utm_source=nextjs-starter'>
      ...
      <p>
        ...
        <a href='https://wundergraph.com/docs/reference/wundergraph_operations_ts/overview?utm_source=nextjs-starter'>
    ...
    <div>
      ...
      {liveWeather.response.status === 'ok' && (
        <div>
          ...
          <p>
            {JSON.stringify(
              liveWeather.response?.body?.data?.getCityByName?.coord
            )}
          </p>
          <h3>Temperature</h3>
          <p>
            {JSON.stringify(
              liveWeather.response?.body?.data?.getCityByName?.weather
                ?.temperature
            )}
          </p>
          <h3>Wind</h3>

...
import type { ClientConfig, FetchConfig, Headers,RequestOptions, Response, UserListener } from "@wundergraph/sdk";
...
export class Client {
	...
	private readonly applicationHash: string = "68e2b335";
